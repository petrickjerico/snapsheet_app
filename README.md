...
Also, the calculator is sentient enough to not make records out of "edge" values (like 0 or Infinity). <br>
...
- Amount trend: shows the total amount at a given time of the account. <br>
...
If a record has a receipt image in the cloud, a quick-access receipt icon lets you view the image directly. <br>
<img src="/gifs/bulk-scan.gif?raw=true" alt="bulk-scan" width="200"/>

## Export
*Maybe you're an accountant? A treasurer?*
Export expenses in CSV format if you need to share your expenses details to others. <br>
...
Play around with a wide selection of colors and icons to create custom categories. <br>
<img src="/gifs/custom-category.gif?raw=true" alt="custom-category" width="200"/>

## Recurring Record
*When some records are just a part of your life.*
Create a recurring expense/income, and let Snapsheet input it manually into an account. <br>
...
Filter the records to view based on other complex parameters: category, time, amount, date. <br>
...
Keep all receipt images safe in the cloud (instead of with other personal pictures of yours). <br>
<img src="/gifs/cloud-storage.gif?raw=true" alt="cloud-storage" width="200"/>

## Demo Mode
*Mess around with Snapsheet before you use it for real!*
Explore the app with some dummy demo data and exit it when you're ready. <br>
